...
SUBJECTS = {
  ...
  MEDIA        - opinion pieces, editorials, interviews, general coverage not fitting the above""",
    ...
    "sjr10": {
        ...
        "kind": "issue",
        "name": "SJR10",
        "subtitle": "Ohio Senate Joint Resolution 10",
        "context": "Ohio Senate Joint Resolution 10 (SJR10)",
        "file_suffix": "_sjr10",
        "keywords": [
            "sjr10",
            "sjr 10",
        ...
        "newsapi_queries": ["SJR10 Ohio", "Ohio Senate Joint Resolution 10"],
        "arcs": ["LEGISLATIVE", "STAKEHOLDERS", "IMPACT", "POLITICS", "MEDIA", "UNMAPPED"],
        "arc_label": {
            "LEGISLATIVE":   "Legislative",
            "STAKEHOLDERS":  "Stakeholders",
  ...
  STAKEHOLDERS - groups, officials, or coalitions taking a position for or against SJR10
  IMPACT       - concrete effects if enacted: what SJR10 would actually change and for whom
  POLITICS     - how the resolution is playing electorally, which candidates are using it, polling
  MEDIA        - opinion pieces, editorials, interviews, general coverage not fitting the above""",
        "arc_fallback_rules": [
            ("LEGISLATIVE",  r"\b(resolution|committee|vote|hearing|sponsor|amendment)\b"),
            ("STAKEHOLDERS", r"\b(coalition|advocacy|group|union|association|oppose|support)\b"),
